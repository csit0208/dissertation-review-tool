...
st.markdown("This tool evaluates dissertation files for grammar, APA citation alignment, and content structure based on rubric scoring. Upload multiple files to review them sequentially.")
...
with st.sidebar:
    ...
    uploaded_files = st.file_uploader("Upload Dissertation(s)", type=["pdf", "docx", "txt"], accept_multiple_files=True)
...
if uploaded_files and reviewer_id and discipline:
    for uploaded_file in uploaded_files:
        ...
        result = evaluate_dissertation(text, discipline)
